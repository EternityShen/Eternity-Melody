...
fn main() -> Result<(), io::Error> {
    ...
    let mut game = Game::new("/home/eternity/Work/Rust/bin/eternity-melody/debug/搁浅.mp3");
    let image_path = Path::new("/home/eternity/Work/Rust/bin/eternity-melody/debug/头像.png");
